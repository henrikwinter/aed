...
$("#btnUpload").click(function (e) {
    ...
    formData.append("Id_Persons", args(1, Workid));
    ...
    $.ajax({
        url: pageVariable.baseSiteURL + 'Ajax/UploadPersonPic',
        type: "POST",
        data: formData,
        dataType: 'json',
        contentType: false,
...
function fnGetPicture(Id, iwith, iheight) {
    var urli = pageVariable.baseSiteURL + "Ajax/GetPersonPic/" + Id + "?version=" + Math.random();
