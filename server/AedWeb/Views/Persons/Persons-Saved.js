...
{ text: '§Bid_Persons§', datafield: 'Bid_Persons', width: 100 },
...
var tesGrid=$("#divGrid_Persons").DXjqxGrid(JqxParam_Grid_Persons);
...
$('#divGrid_Persons').on('rowexpand', function (event) {
    var args = event.args;
